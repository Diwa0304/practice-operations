...
def check_data_drift(reference_path="data/transactions_v1.csv",
                     current_path="data/transactions_v2.csv",
    ...
    full_report = data_drift_report.run(reference_data=reference_df, current_data=current_df)
    
    if not os.path.exists("artifacts"):
        os.makedirs("artifacts")
    full_report.save_html("artifacts/drift_report.html")
